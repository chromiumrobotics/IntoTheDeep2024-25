...
@I2cDeviceType
@DeviceProperties(name = "Neodriver: I2c to Neopixel", description = "Adafruit I2c to Neopixel Bridge", xmlTag = "I2c_to_Neopixel")
public class AdafruitNeodriver extends I2cDeviceSynchDevice<I2cDeviceSynch> {
    ...
    public String getDeviceName() {
        return "Neodriver: i2c to neopixel";
    }
    ...
    public void init_neopixels(){
        ...
        BUFFER_LENGTH_CMD[0] = (byte) neodriverFunctions.NEOPIXEL.bVal;
        ...
        PIN_CONTROL_CMD[0] = (byte) neodriverFunctions.NEOPIXEL.bVal;
    ...
    public byte[] getHardwareID(){
        byte[] reg = new byte[2];
        byte reg1 = (byte) neodriverFunctions.STATUS.bVal;
        byte reg2 = (byte) 0x01;
        reg[0] = reg1;
        reg[1] = reg2;
    ...
    public enum neodriverFunctions {
        NEOPIXEL(0x0E),
        STATUS(0x00);

        public final int bVal;
         neodriverFunctions(int bVal){
            this.bVal = bVal;
        }
    }
